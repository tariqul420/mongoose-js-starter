# Mongoose Quick Start with JavaScript
...
[![GitHub stars](https://img.shields.io/github/stars/tariqul420/mongoose-js-starter?style=social)](https://github.com/tariqul420/mongoose-js-starter/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/tariqul420/mongoose-js-starter?style=social)](https://github.com/tariqul420/mongoose-js-starter/network/members)
...
2. Or clone the repository and remove the .git folder:
   ```bash
   git clone https://github.com/tariqul420/mongoose-js-starter.git my-project
   cd my-project
   rm -rf .git
   git init
   ```
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/tariqul420/mongoose-js-starter.git
   cd mongoose-js-starter
   ```
...
For support, please open an issue in the GitHub repository: [https://github.com/tariqul420/mongoose-js-starter/issues](https://github.com/tariqul420/mongoose-js-starter/issues)
